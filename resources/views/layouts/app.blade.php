					...
					<nav class="col-xl-6 col-lg-7">
						...
						<div class="main-menu">
							...
							<ul>
										...
										<div class="row small-gutters">
											...
											<div class="col-lg-3 d-xl-block d-lg-block d-md-none d-sm-none d-none">
												<div class="banner_menu">
													<a href="#0">
														<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('front/img/banner_menu.jpg') }}" width="400" height="550" alt="" class="img-fluid lazy">
													</a>
												</div>
											</div>
										</div>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="show-submenu">Extras</a>
									<ul>
								...
								<div class="dropdown dropdown-access">
									...
									<div class="dropdown-menu">
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                        <button class="btn_1 form-control">Sign Out</button>
                                        </form> 
                                        @endauth
